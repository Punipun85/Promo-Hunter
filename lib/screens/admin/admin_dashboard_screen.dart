...
class AdminDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activePromos = promoProvider.promos.where((promo) => !promo.isExpired).length;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _statCard(context, 'Total Toko', (promoProvider.stores.length - 1).toString()),
          _statCard(context, 'Total Kategori', (promoProvider.categories.length - 1).toString()),
        ],
      ),
    );
  }
